...
import { createAttempt, getAttempt, saveAnswer, saveTimeSpent, submitAttempt, getPerformanceAnalysis } from "../controllers/attempt.controller.js"
...
router.route("/:attemptId/analysis").get(jwtVerification, getPerformanceAnalysis)
